      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm">
          <div className="flex border-b">
            <button
              className={`py-4 px-6 font-medium cursor-pointer ${activeTab === 'registration' ? 'bg-black text-white rounded-tl-2xl' : 'bg-gray-100'}`}
              onClick={() => setActiveTab('registration')}
            >
              Registration
            </button>
            <button
              className={`py-4 px-6 font-medium cursor-pointer ${activeTab === 'donation' ? 'bg-black text-white' : 'bg-gray-100'}`}
          ...
          {activeTab === 'registration' ? (
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="block text-gray-700">bKash Transaction ID</label>
                  <input
                    type="text"
                    name="bkashId"
                    value={formData.bkashId}
